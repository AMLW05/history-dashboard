...
function buildActivity(a, mn, idx) {
    ...
    // LA4: Data Analysis or other activities
        ...
        if (mn === 3) {
            canvasGuideUrl = 'module3-progressive-era.html';
            canvasGuideTitle = 'LA4: Analyzing Progressive Era Data';
        } else if (mn === 6) {
            canvasGuideUrl = 'module6-civil-rights.html';
            canvasGuideTitle = 'LA4: Analyzing Civil Rights Movement Data';
        }
